...
static int32_t yenc_crc_table[256] = {
...
size_t yenc_decode(char *encoded, unsigned char **p_decoded)
{
    ...
    /* null-byte terminate encoded data before tail */
    *ptail = '\0'; ptail++;
...
#ifdef YENC_CHECK_CRC
    ptmp = strstr(ptail, "crc32=") + 6;
    sscanf(ptmp, "%08x", (unsigned int *)&valid_crc);
#endif
    ...
    /* shrink the out buffer to the actual size */
